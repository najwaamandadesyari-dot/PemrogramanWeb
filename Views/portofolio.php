...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Search icon tepat setelah brand */
  .nav-search-icon {
  ...
  .cert-btn:hover { background: var(--accent-dark); }
...
<nav role="navigation" aria-label="Main navigation">
  ...
  <!-- Search icon bulat — tepat setelah brand, sebelum About -->
...
<main id="main-content">
  ...
  <section id="home">
    ...
    <div class="home-image reveal" style="transition-delay:.2s">
      <div class="home-image-placeholder">
        <svg width="64" height="64" fill="none" viewBox="0 0 24 24" stroke="rgba(255,255,255,0.5)" stroke-width="1.2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
        </svg>
        <span style="font-weight:600;color:rgba(255,255,255,0.8)">Foto Najwa Amanda</span>
        <span style="font-size:.72rem;color:rgba(255,255,255,0.5)">Ganti div ini dengan &lt;img src="foto.jpg"&gt;</span>
      </div>
    </div>
  </section>
    ...
    <div class="about-grid">
      <div class="about-photo reveal">
        <div class="about-photo-placeholder">
          <svg width="48" height="48" fill="none" viewBox="0 0 24 24" stroke="#c66788" stroke-width="1.2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
          </svg>
          <span style="color:#c66788;font-weight:600">Foto Formal</span>
          <span class="about-photo-label">3:4 portrait</span>
        </div>
      </div>
    ...
    <div class="timeline-wrapper reveal" style="transition-delay:.15s">
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-card">
          <div class="timeline-card-img">🌱</div>
  ...
  <section id="certifikat">
    ...
    <div class="cert-grid reveal" style="transition-delay:.15s">
      ...
      <div class="cert-card">
        <div class="cert-img">🎖️</div>
        <button class="cert-btn" onclick="alert('Sertifikat Program Studi Teknik Informatika, Fakultas Teknik dan Ilmu Komputer\nUniversitas Sains Al Quran – 30 Maret 2026')">Details</button>
      </div>
